            ...
            <section ref={quienesSomosRef} className="section-container">
                ...
                <div className="about-us-content">
                    <div className="about-us-description">
                        <p>En Smart-Time, somos más que una aplicación; somos tus aliados en el camino hacia el éxito académico...</p>
                    ...
                    <div className="about-us-details">
                        ...
                        <div className="about-us-why">
                            ...
                            <p>Porque también hemos estado ahí...</p>
                        </div>
                        <div className="about-us-values">
                            <h2>Nuestros valores</h2>
                            <ul>
                                <li>Tu Éxito Primero</li>
                                <li>Inteligencia Práctica</li>
                                <li>Simplicidad Poderosa</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section ref={funcionalidadesRef} className="section-container">
                ...
                <div className="features-grid">
                    <div className="feature-card">
                        ...
                        <p>Visualiza tu mes, semana y día...</p>
                    </div>
